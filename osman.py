...
if authentication_status:
    ...
    with st.sidebar:
        ...
        selected_file = option_menu(
            ...
            options=["Pivot PAT/SAT",
                     "Nilai Std. SD, SMP, 10KM",
                     "Nilai Std. All IPA",
                     "Nilai Std. 10, 11 IPS",
                     "Nilai Std. PPLS, RONIN IPS",
                     "Nilai Std. 11KM"],
        )
    if selected_file == "Pivot PAT/SAT":
    ...
    if selected_file == "Nilai Std. SD, SMP, 10KM":
        ...
        with col6:
            KELAS = st.selectbox(
                "KELAS",
                ("--Pilih Kelas--", "4 SD", "5 SD", "6 SD", "7 SMP", "8 SMP", "9 SMP", "10 KM"))
        ...
        with col8:
            PENILAIAN = st.selectbox(
                "PENILAIAN",
                ("--Pilih Penilaian--", "PENILAIAN AKHIR TAHUN", "SUMATIF AKHIR TAHUN"))
